const audiences = [
  {
    ...
    description:
      "Practical, personalised help with every decision — plus an organised record of everything already done.",
    icon: (
  ...
  },
  {
    ...
    description:
      "Structured farm information and dependable decision support across teams, fields, and seasons.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
  ...
  },
  {
    ...
    description:
      "Input suppliers, cooperatives, insurers, and extension services joining the platform as it grows.",
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
      ...
      <div className="mx-auto max-w-7xl">
        <div className="max-w-2xl">
          ...
          <h2 className="display-heading reveal mt-5 font-display text-3xl font-medium leading-[1.15] tracking-tight text-agro-ink sm:text-4xl lg:text-[2.9rem]">
            Growing outward from the farmer
          </h2>
        </div>
