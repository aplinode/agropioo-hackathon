/* GET  /api/app-control/conversations — list the signed-in farmer's app-control conversations
   POST /api/app-control/conversations — create a new conversation */

import { query, queryOne } from "@/lib/db";
import { requireSessionApi } from "@/lib/auth/guards";
import { errorResponse, jsonResponse, readJsonBody } from "@/lib/http";
import { createConversationSchema } from "@/lib/validation/app-control";
