...
const rowIcons = {
  ...
  crop: "M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z",
  sowing: "M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5",
  land: "M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909M3.75 21h16.5A1.5 1.5 0 0021.75 19.5V4.5A1.5 1.5 0 0020.25 3H3.75A1.5 1.5 0 002.25 4.5v15A1.5 1.5 0 003.75 21z",
} as const;

export default async function SetupFarm({ locale }: { locale: Locale }) {
  const { t } = await getDictionary(locale);
  const L = (key: Parameters<typeof t>[0]) => localized(t(key), locale);

  const profileRows = [
    { label: L("hiw.setup.rowDistrict"), value: L("hiw.setup.valDistrict"), icon: rowIcons.district },
    { label: L("hiw.setup.rowCrop"), value: L("hiw.setup.valCrop"), icon: rowIcons.crop },
    { label: L("hiw.setup.rowSowing"), value: L("hiw.setup.valSowing"), icon: rowIcons.sowing },
    { label: L("hiw.setup.rowLand"), value: L("hiw.setup.valLand"), icon: rowIcons.land },
  ];
    ...
    >
      <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
        ...
        <div
          ...
          role="img"
          aria-label={t("hiw.setup.mockLabel").text}
        >
