const outcomes = [
  {
    ...
    description: "Every choice — water, input, timing — backed by data instead of habit.",
    icon: (
  ...
  },
  {
    ...
    description: "Healthy crops, well-timed inputs, and harvests picked at their peak.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
  ...
  {
    title: "Fewer avoidable losses",
    description: "Disease, pests, and weather caught early — before they take the yield.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
  ...
  {
    title: "Farms run like businesses",
    description: "Structured records and season intelligence that banks and buyers respect.",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden="true">
        ...
        <div className="grid gap-8 lg:grid-cols-12 lg:items-end">
          <div className="lg:col-span-7">
            ...
            <h2 className="display-heading reveal mt-5 font-display text-3xl font-medium leading-[1.15] tracking-tight text-agro-ink sm:text-4xl lg:text-[2.9rem]">
              Four outcomes we hold ourselves to
            </h2>
          </div>
          <p className="reveal max-w-md leading-relaxed text-agro-slate lg:col-span-4 lg:col-start-9">
            The vision is not the app — it is what changes on the farm.
            Everything ships against these four results.
          </p>
        </div>
