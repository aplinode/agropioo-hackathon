...
function CommitmentIcon({ variant }: { variant: number }) {
  if (variant === 1) {
    return (
...
export default async function Principles({ locale }: { locale: Locale }) {
  const { t } = await getDictionary(locale);
  const L = (key: Parameters<typeof t>[0]) => localized(t(key), locale);

  const commitments = ([
    { titleKey: "vp.principles.c1Title", descKey: "vp.principles.c1Desc", variant: 1 },
    { titleKey: "vp.principles.c2Title", descKey: "vp.principles.c2Desc", variant: 2 },
    { titleKey: "vp.principles.c3Title", descKey: "vp.principles.c3Desc", variant: 3 },
    { titleKey: "vp.principles.c4Title", descKey: "vp.principles.c4Desc", variant: 4 },
    { titleKey: "vp.principles.c5Title", descKey: "vp.principles.c5Desc", variant: 5 },
    { titleKey: "vp.principles.c6Title", descKey: "vp.principles.c6Desc", variant: 6 },
  ] as { titleKey: Parameters<typeof t>[0]; descKey: Parameters<typeof t>[0]; variant: number }[]).map((c) => ({
    title: L(c.titleKey),
    description: L(c.descKey),
    icon: <CommitmentIcon variant={c.variant} />,
  }));
